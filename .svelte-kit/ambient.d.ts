...
declare module '$env/static/private' {
	...
	export const EFC_11688: string;
	export const envContainerTelemetryApiCmdLine: string;
	export const ES_PASSWORD: string;
	export const ES_USERNAME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		EDITOR: string;
		EFC_11688: string;
		envContainerTelemetryApiCmdLine: string;
		ES_PASSWORD: string;
		ES_USERNAME: string;
